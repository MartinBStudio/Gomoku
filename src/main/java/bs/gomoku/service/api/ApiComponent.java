...
import static bs.gomoku.service.events.INotifier.Type.PROFILE_UPDATED;
...
public class ApiComponent {
    ...
    public void makeRequest(JobsRequest request) {
    ...
    private class ResponseHandlers implements INotifier {
        ...
        private JobsGame.Coords handleNewDumbCoords() {
        ...
        private void handleCheckStatus(JobsResponse r) {
            ...
            if (actualPlayerId.equals(profile.getUserId())
                ...
                if (currentGame.getIsEnemyMainProfile()) {
                    currentGame.setCoords(handleNewDumbCoords());
                } else {
